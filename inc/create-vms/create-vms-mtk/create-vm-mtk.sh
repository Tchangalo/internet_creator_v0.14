...
if [[ "$router" == "10" ]]; then
    ...
    $(for i in {1..8}; do
        echo "/routing bgp connection add address-families=ip as=65001 local.address=10.1.255.10 local.role=ibgp-rr name=p1r${i}v nexthop-choice=force-self remote.address=10.1.255.${i} remote.as=65001 router-id=10.1.255.10"
    done)
    /routing bgp connection add address-families=ip as=65001 local.address=10.1.255.10 local.role=ibgp name=p1r9v nexthop-choice=force-self remote.address=10.1.255.9 remote.as=65001 router-id=10.1.255.10
    $(for i in 11 12; do
        echo "/routing bgp connection add address-families=ip as=65001 local.address=10.1.255.10 local.role=ibgp-rr name=p1r${i}m nexthop-choice=force-self remote.address=10.1.255.${i} remote.as=65001 router-id=10.1.255.10"
    done)
EOF
    ...
    /routing bgp connection add address-families=ip as=65001 local.address=10.1.255.11 local.role=ibgp name=p1r9v nexthop-choice=force-self remote.address=10.1.255.9 remote.as=65001 router-id=10.1.255.11
    /routing bgp connection add address-families=ip as=65001 local.address=10.1.255.11 local.role=ibgp name=p1r10m nexthop-choice=force-self remote.address=10.1.255.10 remote.as=65001 router-id=10.1.255.11
EOF
    ...
    /routing bgp connection add address-families=ip as=65001 local.address=10.1.255.12 local.role=ibgp name=p1r9v nexthop-choice=force-self remote.address=10.1.255.9 remote.as=65001 router-id=10.1.255.12
    /routing bgp connection add address-families=ip as=65001 local.address=10.1.255.12 local.role=ibgp name=p1r10m nexthop-choice=force-self remote.address=10.1.255.10 remote.as=65001 router-id=10.1.255.12
EOF
fi
